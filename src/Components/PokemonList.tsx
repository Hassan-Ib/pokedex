...
const PokemonList = ({ result }: { result: TPokemon[] }) => {
  ...
  return (
    <section className="">
      <ul className="md:scroll-effect w-[95%] max-w-5xl lg:max-w-xl lg:mx-px py-6 pt-2 flex flex-col sm:flex-row  flex-wrap md:flex-nowrap sm:justify-center md:justify-start md:overflow-auto mx-auto  gap-4">
        {result.map((pokemon) => {
